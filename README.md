About pymatgen-diffusion-feedstock
==================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pymatgen-diffusion-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7462&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pymatgen-diffusion-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pymatgen-diffusion` can be installed with `conda`:
...
```
mamba install pymatgen-diffusion
```

It is possible to list all of the versions of `pymatgen-diffusion` available on your platform with `conda`:
...
```
mamba search pymatgen-diffusion --channel conda-forge
```
...
mamba repoquery search pymatgen-diffusion --channel conda-forge

# List packages depending on `pymatgen-diffusion`:
mamba repoquery whoneeds pymatgen-diffusion --channel conda-forge

# List dependencies of `pymatgen-diffusion`:
mamba repoquery depends pymatgen-diffusion --channel conda-forge
```
